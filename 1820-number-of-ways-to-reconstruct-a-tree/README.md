<h2><a href="https://leetcode.com/problems/number-of-ways-to-reconstruct-a-tree">Number Of Ways To Reconstruct A Tree</a></h2> <img src='https://img.shields.io/badge/Difficulty-Hard-red' alt='Difficulty: Hard' /><hr><p>You are given an array <code>pairs</code>, where <code>pairs[i] = [x<sub>i</sub>, y<sub>i</sub>]</code>, and:</p>
